...
import { deleteCtg } from "../../helper/categoriesHelper/ctg";
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              ...
              onClick={() => navigator.clipboard.writeText(ctg.name)}
            >
              <svg
                width="15"
                height="15"
            ...
            <DropdownMenuItem
              onClick={() => {
                deleteCtg(row.original._id, Store.getState().ctg);
              }}
